...
// member functions
  ...
  void     PrintIdentifiedWilsonLines(const vector<vector<int> > &IdentifiedWilsonLines) const;
  bool     PrintNonLocalBreaking(const COrbifold &Orbifold, const SConfig &VEVConfig, bool CheckVEVConfigGroupFromSimpleGUTGroup = true) const;
  ...
  void     PrintState(const CState &State, const CSector &Sector, const CFixedBrane &FixedBrane, const SConfig &VEVConfig, const COrbifoldGroup &OrbifoldGroup) const;
