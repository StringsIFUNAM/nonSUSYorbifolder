...
// member functions
  ...
  CSpectrum(const SConfig &Vacuum1, const SConfig &Vacuum2, const vector<SUSYMultiplet> &SUSYTypes, string Label = "", const vector<vector<unsigned> > *SectorsForAdditionalIdentifier = NULL);
  ~CSpectrum();
